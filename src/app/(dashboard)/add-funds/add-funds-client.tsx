  ...
  return (
    <div className="grid lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        {/* Add Funds Form */}
        <form onSubmit={handleSubmit} className="bg-surface-container-lowest rounded-2xl p-6 shadow-card space-y-6">
          <h3 className="text-xl font-bold text-on-surface">Add Funds</h3>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                max="10000"
                step="0.01"
                className="w-full pl-12 pr-4 py-3 rounded-xl bg-surface-container border border-outline-variant/20 text-on-surface placeholder:text-on-surface-variant focus:outline-none focus:ring-2 focus:ring-primary"
                required
              />
            </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-xl bg-surface-container border border-outline-variant/20 text-on-surface focus:outline-none focus:ring-2 focus:ring-primary"
              required
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 rounded-xl bg-surface-container border border-outline-variant/20 text-on-surface placeholder:text-on-surface-variant focus:outline-none focus:ring-2 focus:ring-primary resize-none"
              required
            />
            <p className="text-xs text-on-surface-variant mt-1">
      ...
      <div className="space-y-6">
        <div className="bg-surface-container-lowest rounded-2xl p-6 shadow-card">
          <h3 className="text-lg font-bold text-on-surface mb-4">How to Add Funds</h3>
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6">
          <h3 className="text-lg font-bold text-on-surface mb-3">Important Notes</h3>
        ...
        <div className="bg-surface-container-lowest rounded-2xl p-6 shadow-card">
          <h3 className="text-lg font-bold text-on-surface mb-3">Need Help?</h3>
          <p className="text-sm text-on-surface-variant mb-4">
            Contact our support team for payment assistance
          </p>
          <a
            href="/tickets"
            className="block text-center px-4 py-2 rounded-xl bg-surface-container text-on-surface font-medium hover:bg-surface-container-high transition-all"
          >
